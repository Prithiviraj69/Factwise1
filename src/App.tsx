...
import celebritiesData from "./components/celebritiesData/celebrities.json";
...
function App() {
  ...
  useEffect(() => {
    if (!localStorage.getItem("celebritiesUserData")) {
      localStorage.setItem("celebritiesUserData", JSON.stringify(celebritiesData));
      setUserData(celebritiesData);
    } else {
      let data = localStorage.getItem("celebritiesUserData");
